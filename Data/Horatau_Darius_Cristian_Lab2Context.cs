...
namespace Horatau_Darius_Cristian_Lab2.Data
{
    public class Horatau_Darius_Cristian_Lab2Context : DbContext
    {
        ...
        public DbSet<Horatau_Darius_Cristian_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Horatau_Darius_Cristian_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
